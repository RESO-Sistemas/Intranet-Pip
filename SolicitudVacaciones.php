...
<body>
				...
				<div class="content-wrapper">
					<div class="container">
									...
									<div class="card-body d-flex align-items-center gap-3 p-3">
										<div class="d-flex align-items-center justify-content-center rounded-3 flex-shrink-0"
											...
											<span class="material-symbols-outlined"
												style="color:#2563EB;font-size:24px;">beach_access</span>
										</div>
										<div>
											<div class="text-muted"
												style="font-size:11px;font-weight:600;letter-spacing:.5px;text-transform:uppercase;">
												Total</div>
											<div id="statTotal" class="fw-bold" style="font-size:22px;line-height:1.1;">
												—</div>
										</div>
									</div>
								</div>
								...
								<div class="card h-100 border-0 shadow-sm" style="border-radius:14px;">
									<div class="card-body d-flex align-items-center gap-3 p-3">
										<div class="d-flex align-items-center justify-content-center rounded-3 flex-shrink-0"
											...
											<span class="material-symbols-outlined"
												style="color:#047857;font-size:24px;">schedule</span>
										</div>
										<div>
											<div class="text-muted"
												style="font-size:11px;font-weight:600;letter-spacing:.5px;text-transform:uppercase;">
												Pendientes</div>
											<div id="statPendientes" class="fw-bold"
								...
								<div class="card h-100 border-0 shadow-sm" style="border-radius:14px;">
									<div class="card-body d-flex align-items-center gap-3 p-3">
										<div class="d-flex align-items-center justify-content-center rounded-3 flex-shrink-0"
											...
											<span class="material-symbols-outlined"
												style="color:#059669;font-size:24px;">check_circle</span>
										</div>
										<div>
											<div class="text-muted"
												style="font-size:11px;font-weight:600;letter-spacing:.5px;text-transform:uppercase;">
												Aceptadas</div>
											<div id="statAceptadas" class="fw-bold"
												style="font-size:22px;line-height:1.1;">—</div>
										</div>
									</div>
								</div>
								...
								<div class="card h-100 border-0 shadow-sm" style="border-radius:14px;">
									<div class="card-body d-flex align-items-center gap-3 p-3">
										<div class="d-flex align-items-center justify-content-center rounded-3 flex-shrink-0"
											...
											<span class="material-symbols-outlined"
												style="color:#DC2626;font-size:24px;">cancel</span>
										</div>
										<div>
											<div class="text-muted"
												style="font-size:11px;font-weight:600;letter-spacing:.5px;text-transform:uppercase;">
												Denegadas</div>
											<div id="statDenegadas" class="fw-bold"
												style="font-size:22px;line-height:1.1;">—</div>
										</div>
									</div>
								</div>
						...
						<div class="row">
							<div class="col">
								<div
									class="page-description page-description-tabbed d-flex justify-content-between align-items-center flex-wrap gap-2">
	...
	<div class="modal fade" id="modalActualizarFirma" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
		aria-hidden="true">
		<div class="modal-dialog modal-dialog-centered">
			<div class="modal-content">
				...
				<div class="modal-footer d-flex justify-content-between">
					...
					<button type="button" id="draw-submitBtnVac"
