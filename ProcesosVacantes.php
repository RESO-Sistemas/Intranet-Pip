                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-md-5">
                                                ...
                                                <input id="txtDescripcion" type="text" class="form-control" placeholder="Breve detalle del objetivo del proceso">
                                            </div>
                                            <div class="col-12 col-md-2 d-flex align-items-end">
                                                <button type="button" class="btn btn-success w-100 mt-3 mt-md-0" id="btnAddProceso">
