import { Property, ChildProperty, initializeCSPTemplate, getValue, isNullOrUndefined, matches, closest, select, createElement, setValue, detach, extend, Ajax, Fetch, remove, Internationalization, selectAll, Draggable, KeyboardEvents, EventHandler, Touch, addClass, removeClass, isVisible, getUniqueID, setStyleAttribute, formatUnit, Browser, L10n, Complex, Collection, Event, NotifyPropertyChanges, Component, SanitizeHtmlHelper } from '@syncfusion/ej2-base';
...
var FileManager = /** @class */ (function (_super) {
    ...
    FileManager.prototype.allowOrDenyUpload = function (args, uploadDetails) {
        ...
        var hasFolder = args.filesData.some(function (f) {
            var name = !isNullOrUndefined(f.name) ? f.name : '';
...
var NavigationPane = /** @class */ (function () {
    ...
    NavigationPane.prototype.onInit = function () {
        ...
        this.treeObj = new TreeView({
            fields: __assign({ dataSource: [rootData], id: '_fm_id', parentID: '_fm_pId', expanded: '_fm_expanded', selected: '_fm_selected', text: 'name', hasChildren: 'hasChild' }, (isNullOrUndefined(this.parent.navigationPaneTemplate) && { iconCss: '_fm_icon' }), { htmlAttributes: '_fm_htmlAttr', tooltip: 'name' }),
            enableHtmlSanitizer: this.parent.enableHtmlSanitizer,
    ...
    NavigationPane.prototype.onNodeExpand = function (args) {
        ...
        if (args.node.querySelector('.' + LIST_ITEM) === null) {
            ...
            var newText = isNullOrUndefined(id) ? nodeData[0].name : id;
