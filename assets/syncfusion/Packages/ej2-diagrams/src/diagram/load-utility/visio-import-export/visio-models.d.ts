...
import { DecoratorShapes, DetermineShapeResult, FontProps, FormattedColors, GradientStop, GradientVector, LineStyleList, NormalizedVisioData, OrderEntry, RadialGradientConfig, ShapeAddInfo, VarientStyle, VisioMedia, VisioPort, VisioRow } from './visio-types';
 ...
 * @private
 */
export declare class VisioNodeStyle {
    /**
 ...
 * @private
 */
export declare class VisioNodeShadow {
    /**
 ...
 * @private
 */
export declare class VisioShape {
    /**
 ...
 * @private
 */
export declare class VisioWindow {
    /**
 ...
 * @private
 */
export declare class VisioPage {
    /**
 ...
 * @private
 */
export declare class VisioMaster {
    /**
 ...
 * @private
 */
export declare class VisioTheme {
    /**
     ...
     */
    connLineStyles?: Array<{
        name: string;
        value: LineStyleEntry;
    }>;
    /**
 ...
 * @private
 */
export declare class VisioDocumentSettings {
    /**
 ...
 * @private
 */
export declare class VisioConnectionData {
    /**
 ...
 * @private
 */
export declare class VisioRelationship {
    /**
 ...
 * @private
 */
export declare class VisioDiagramData {
    /**
