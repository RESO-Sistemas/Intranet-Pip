 ...
 * @private
 */
export declare type ValueLike = string | number | {
    value: string;
};
/**
 ...
 */
export declare type XmlStringMap = {
    [key: string]: string;
};
/**
 ...
 */
export declare type ForeignDataBlock = {
    $?: XmlStringMap;
    Rel?: {
        $?: XmlStringMap;
    } | Array<{
 ...
 * @private
 */
export declare type RowType = 'MoveTo' | 'RelMoveTo' | 'RelLineTo' | 'LineTo' | 'ArcTo' | 'EllipticalArcTo' | 'RelCubBezTo' | 'CubicBezierTo' | 'QuadBezierTo' | 'Ellipse' | 'Connection' | 'NURBSTo' | 'SplineStart' | 'SplineKnot' | 'Custom1' | 'Custom2';
/**
 ...
 * @private
 */
export declare type VisioShapeKind = 'Shape' | 'Group' | 'Page' | 'Guide' | 'Foreign';
/**
 ...
 * @private
 */
export declare type WindowType = 'Drawing' | 'Stencil' | string;
/**
 ...
 * @private
 */
export declare type FormattedColors = Record<string, string>;
/**
 ...
 */
export declare type ColorReferenceArray = Array<{
    /**
...
export interface LineStyleRef {
    ...
    lineCap: number | null;
    lineComp: number;
    fillStyle: TransformedColorRef | null;
 ...
 * @private
 */
export declare type Vec2 = Readonly<Point>;
/**
 ...
 * @private
 */
export declare type FlatTransform = Partial<Record<Transform['type'], number>>;
/**
 ...
 * @private
 */
export declare type ParsedXmlObject = Record<string, unknown>;
/**
 ...
 * @private
 */
export declare type CellMapValue = string | number | boolean | undefined;
/**
 ...
 * @private
 */
export declare type ConnectorType = 'Straight' | 'Orthogonal' | 'Bezier';
/**
 ...
 * @private
 */
export declare type DecoratorShapes = 'None' | 'Arrow' | 'OpenArrow' | 'Square' | 'Circle' | 'Diamond' | 'Fletch' | 'OpenFetch' | 'IndentedArrow' | 'OutdentedArrow' | 'DoubleArrow' | 'Custom';
/**
 ...
 * @private
 */
export declare type BPMNShape = BPMNEventShape | BPMNGatewayShape | BPMNActivityShape | BPMNDataObjectShape | BPMNTextAnnotationShape | BPMNSimpleShape;
/**
 ...
 * @private
 */
export declare function isBPMNEventShape(shape: BPMNShape): shape is BPMNEventShape;
/**
 ...
 * @private
 */
export declare function isBPMNActivityShape(shape: BPMNShape): shape is BPMNActivityShape;
/**
 ...
 * @private
 */
export declare function isBPMNGatewayShape(shape: BPMNShape): shape is BPMNGatewayShape;
/**
 ...
 * @private
 */
export declare type GroupTransform = {
    pinX: number;
    pinY: number;
    locPinX: number;
    locPinY: number;
 ...
 * @private
 */
export declare type DetermineShapeResult = {
    type: 'Basic';
    shape: string;
} | {
    type: 'Flow';
 ...
 * @private
 */
export declare type BPMNPropertyMapType = Map<string, string>;
/**
 ...
 * @private
 */
export declare type BPMNShapeResult = BPMNEventShapeResult | BPMNGatewayShapeResult | BPMNActivityShapeResult | BPMNDataObjectShapeResult | BPMNTextAnnotationShapeResult | BPMNSimpleShapeResult;
/**
...
export declare type NodeGradientType = 'Linear' | 'Radial';
 ...
 */
export declare type ConnectorShapePayload = BPMNFlowShapeResult | UMLConnectorResult | undefined;
/**
 ...
 */
export declare type ConnectorGradient = LinearConnectorGradient | RadialConnectorGradient;
/**
