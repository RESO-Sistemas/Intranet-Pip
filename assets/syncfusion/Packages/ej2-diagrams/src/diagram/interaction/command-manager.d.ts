...
export declare class CommandHandler {
    ...
    clonedChildrenTable: {};
    /** @private */
    annotationRestrictDeltaValue: PointModel;
    private childTable;
    private objectStore;
    private parentTable;
    private blazor;
    ...
    /** @private */
    trackConnectorChange(selectorModel: SelectorModel): void;
    ...
    private assignZindexAndAddNode;
     ...
     */
    group(): void;
    private updateGroupInZindexTable;
    /**
     * unGroup method\
     *
    ...
    private updateGroupChildrenOrder;
...
Remove terinal segment in initial
    ...
    /** @private */
    getTextAnnotation(source: IElement): SelectorModel;
    private getBpmnTextNodes;
    /** @private */
    getContainer(source: IElement): SelectorModel;
    /**   @private  */
     ...
     * @private
     */
    isParentAsContainer(node: NodeModel | ConnectorModel, isChild?: boolean): boolean;
    /**
     * @returns { boolean } isParentAsContainer method .\
