 ...
 * @private
 */
export declare function updateCanvasBounds(diagram: Diagram, obj: NodeModel | ConnectorModel, position: PointModel, isBoundsUpdate: boolean, groupAction: boolean): boolean;
/**
...
export declare function updateLaneBoundsAfterAddChild(container: NodeModel, swimLane: NodeModel, node: NodeModel | SelectorModel, diagram: Diagram, isBoundsUpdate?: boolean, isSelector?: boolean, isGroupAction?: boolean): boolean;
export declare function updateLaneSizeAfterGridChange(swimLane: NodeModel, isHorizontal: boolean, container: NodeModel): void;
export declare function updateSwimlaneSize(swimLane: NodeModel, isHorizontal: boolean): number;
/**
