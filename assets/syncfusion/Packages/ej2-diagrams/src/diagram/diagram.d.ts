...
import { ZoomOptions, IPrintOptions, IExportOptions, IFitOptions, ActiveLabel, IEditSegmentOptions, OverviewObject } from './objects/interface/interfaces';
...
import { ImportAndExportVisio, VisioImportOptions, VisioExportOptions } from './load-utility/visio-import-export/visio-import-export';
...
export declare class Diagram extends Component<HTMLElement> implements INotifyPropertyChanged {
     ...
     * @private
     */
    importAndExportVisioModule: ImportAndExportVisio;
    /**
     ...
     * @private
     */
    diagramCollaborationModule: DiagramCollaboration;
    /**
     ...
     * @private
     */
    initialScrollValues: ScrollValues;
    /**
    ...
    /** @private */
    isCollaborativeContainerChanges: boolean;
    /**
    ...
    updateGradient(newProp: NodeModel, oldProp: NodeModel, nodeObj: Node): void;
     ...
     * @private
     */
    canRotateOnNegativeAxis(objWrapper: GroupableView | TextElement): boolean;
    /**
     ...
     */
    getDiagramUpdates(args: IHistoryChangeArgs): string[];
    /**
     ...
     */
    private saveSequenceDiagramAsMermaid;
    private isSequenceDiagram;
    /**
     ...
     * @returns {void}
     */
    private loadSequenceDiagramFromMermaid;
    /**
    ...
    private hasNestingContainer;
    private sortContainersTopologically;
    private alignGroup;
    private addToLayer;
    private updateLayer;
    ...
    private initNode;
    private isNotContainerOrSubProcess;
    private isNotSwimlaneObject;
    private updateLaneAfterAddChild;
     ...
     * @private
     */
    renderDiagramElements(canvas: HTMLCanvasElement | SVGElement, renderer: DiagramRenderer, htmlLayer: HTMLElement, transform?: boolean, fromExport?: boolean, isOverView?: boolean, fromSetOverview?: boolean): void;
    /**
     ...
     * @private
     */
    getWrapper(nodes: GroupableView, id: string): DiagramElement;
    /**
     ...
     * @private
     */
    hasSelectedConnector(node: Node): boolean;
     ...
     * @private
     */
    updateConnectorProperties(connector: ConnectorModel): void;
    /**
     ...
     * @private
     */
    updateNodeProperty(element: GroupableView, visible?: boolean, opacity?: number): void;
    /**
     ...
     * @private
     */
    updateElementVisibility(element: GroupableView, obj: Connector | Node, visible: boolean): void;
     ...
     * @private
     */
    updateConnectorfixedUserHandle(changedObject: ConnectorFixedUserHandleModel, actualfixedUserHandle: ConnectorFixedUserHandleModel, nodes: GroupableView, actualObject?: Object, canUpdateSize?: boolean): void;
    /**
     ...
     * @private
     */
    updateAnnotation(changedObject: AnnotationModel, actualAnnotation: ShapeAnnotationModel, nodes: GroupableView, actualObject?: Object, canUpdateSize?: boolean): void;
     ...
     * @private
     */
    updateNodefixedUserHandle(changedObject: NodeFixedUserHandleModel, actualfixedUserHandle: NodeFixedUserHandleModel, nodes: GroupableView, actualObject?: Object): void;
     ...
     * @private
     */
    updatePort(changedObject: PointPortModel, actualPort: PointPortModel, nodes: GroupableView, actualObject?: Connector): void;
    /**
     * updateIcon method \
     *
    ...
    private moveNode;
    private moveNodeWithTargetLayer;
    private getRootParentId;
    /**
     ...
     */
    importFromVisio(file: File | Blob, options?: VisioImportOptions): Promise<string[]>;
    /**
     ...
     */
    exportToVisio(options?: VisioExportOptions): Promise<void>;
}
