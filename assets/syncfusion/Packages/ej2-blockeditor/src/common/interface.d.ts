...
export declare type IRemoveBlockOptions = IBlockOptions;
export declare type IDuplicateBlockOptions = IBlockOptions;
...
export interface IMentionRenderOptions {
    ...
    dataSource?: {
        [key: string]: Object;
    }[] | UserModel[] | LabelItemModel[] | CommandItemModel[];
    cssClass?: string;
    highlight?: boolean;
...
export interface IUndoRedoState {
    ...
    action?: actionType;
    data?: IBlockData | IMoveOperation | IIndentOperation | IDeleteOperation | IAddOperation | ITransformOperation | IMultipleBlocksTransformOperation | IMultiDeleteOperation | IClipboardPasteOperation | IFormattingOperation | ITableRowInsertOptions | ITableColumnInsertOptions | ITableCellsClearOperation | ITableCellsPasteOperation | IBulkRowsDeleteOperation | IBulkColumnsDeleteOperation | ITableHeaderInputOperation;
    undoSelection?: IBlockSelectionState;
    redoSelection?: IBlockSelectionState;
}
export declare type SubCommand = 'link';
