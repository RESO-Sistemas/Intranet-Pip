...
export declare class Grid extends Component<HTMLElement> implements INotifyPropertyChanged {
     ...
     */
    setCellValueAsync(key: string | number, field: string, value: string | number | boolean | Date | null, delay: number): Promise<void>;
    /**
     ...
     */
    setRowDataAsync(key: string | number, rowData?: Object, delay?: number): Promise<void>;
     ...
     */
    goToPageAsync(pageNo: number): Promise<void>;
    /**
     ...
     */
    sortColumnAsync(columnName: string, direction: SortDirection, isMultiSort?: boolean): Promise<void>;
    /**
     ...
     *
     */
    changeDataSource(dataSource?: Object | DataManager | DataResult, columns?: Column[] | string[] | ColumnModel[], properties?: Object): void;
    /**
     ...
     */
    clearSortingAsync(): Promise<void>;
    /**
     ...
     */
    filterByColumnAsync(fieldName: string, filterOperator: string, filterValue: string | number | Date | boolean | number[] | string[] | Date[] | boolean[] | null, predicate?: string, matchCase?: boolean, ignoreAccent?: boolean, actualFilterValue?: string, actualOperator?: string): Promise<void>;
    /**
     ...
     */
    deleteRecordAsync(fieldname?: string, data?: Object): Promise<void>;
    /**
     ...
     */
    addRecordAsync(data?: Object, index?: number): Promise<void>;
    /**
     ...
     */
    deleteRowAsync(tr: HTMLTableRowElement): Promise<void>;
    /**
     ...
     */
    updateRowAsync(index: number, data: Object): Promise<void>;
    /**
     ...
     */
    groupColumnAsync(columnName: string): Promise<void>;
    /**
     ...
     */
    ungroupColumnAsync(columnName: string): Promise<void>;
    /**
     ...
     * @hidden
     */
    getPinnedRowObjectByKey(value: string | Object): Row<Column> | undefined;
    /**
