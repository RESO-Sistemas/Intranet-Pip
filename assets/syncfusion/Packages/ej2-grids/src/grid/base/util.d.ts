 ...
 */
export declare function getScrollBarWidth(changeWidth?: boolean): number;
/**
 ...
 * @hidden
 */
export declare function toggleFilterUI(operator: string, columnUid: string, column: Column | ColumnModel, columnType: string, dlgObj: Dialog, previousValue: string): void;
/**
 * @param {Element} elem - Defines the element
 * @returns {void}
 * @hidden
 ...
 * @hidden
 */
export declare function getColumnWidth(column: Column, gObj: IGrid): number;
/**
 ...
 * @hidden
 */
export declare function resetDialogAppend(gObj: IGrid, dlgObj: Dialog, dlgWidth?: number): void;
/**
 * @param {Column} column - Defines the column
...
export declare function getSerachFilteredData(grid: IGrid): Object[];
/**
 ...
 * @hidden
 */
export declare function isEnableSeamlessScrolling(): boolean;
/**
 ...
 * @hidden
 */
export declare function setEnableSeamlessScrolling(value: boolean): void;
