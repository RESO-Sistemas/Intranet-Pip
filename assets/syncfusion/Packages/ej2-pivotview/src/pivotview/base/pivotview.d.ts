...
export declare class PivotView extends Component<HTMLElement> implements INotifyPropertyChanged {
    ...
    private onSuccess;
    private triggerAfterServiceInvoke;
    /** @hidden */
    getEngine(action: string, drillItem?: IDrilledItem, sortItem?: ISort, aggField?: IFieldOptions, cField?: ICalculatedFields, filterItem?: IFilter, memberName?: string, rawDataArgs?: FetchRawDataArgs, editArgs?: UpdateRawDataArgs, excelExportProperties?: ExcelExportProperties, isPivotTableExport?: boolean): void;
    /**
     ...
     */
    excelExport(excelExportProperties?: ExcelExportProperties, isMultipleExport?: boolean, workbook?: Workbook, isBlob?: boolean): Promise<Workbook>;
     ...
     * };
     */
    exportAsPivot(exportType?: PivotExportType): void;
    /**
     ...
     * @hidden
     */
    getBeforeServiceInvoke(args: BeforeServiceInvokeEventArgs): BeforeServiceInvokeEventArgs;
    /**
     ...
     * @hidden
     */
    getAfterServiceInvoke(response: AfterServiceInvokeEventArgs): AfterServiceInvokeEventArgs;
    /**
     * De-Register the internal events.
     *
    ...
    /** @hidden */
    applyFormatting(pivotValues: IAxisSet[][], dataSourceSettings?: DataSourceSettingsModel): void;
