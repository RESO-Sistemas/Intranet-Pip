...
export declare class PivotEngine {
    ...
    private rowValueSortHeaderText;
    private columnValueSortHeaderText;
    ...
    generateGridData(dataSource: IDataOptions, requireDatasourceUpdate?: boolean, isExport?: boolean, headerCollection?: HeaderCollection, isScrolled?: boolean): void;
    ...
    private applySortingForAxis;
    private prepareValueSortHeaderText;
    private getHeaderDetails;
    private getMember;
