...
<head>
    ...
    <style>
        ...
        .pli-status.en-proceso { background: #cfe2ff; color: #084298; }
        .pli-status.aceptado   { background: #d1e7dd; color: #0f5132; }
        .pli-status.rechazado  { background: #f8d7da; color: #842029; }
        .pli-status.finalizado { background: #e2e3e5; color: #41464b; }
                                    ...
                                    <div class="split-pane-wrapper">
                                        ...
                                        <div class="split-pane-master">
                                            ...
                                            <div class="master-search position-relative">
                                                ...
                                                <input type="text" id="buscarPostulanteInput" class="form-control" placeholder="Buscar por nombre, CURP o vacante...">
                                            </div>
                                            <!-- Lista de postulantes -->
                                            <div class="card-body">
                                                <ul class="postulante-list" id="postulanteList">
                                                    <li class="postulante-list-empty">
                                                        <span class="material-symbols-outlined d-block mb-2" style="font-size:2.5rem;">hourglass_empty</span>
                                                        Cargando...
                                                    </li>
                                                </ul>
                                            </div>
                                        ...
                                        <div class="split-pane-detail" id="detailPanel">
                                            ...
                                            <div class="empty-state" id="detailEmptyState">
                                                ...
                                                <p class="text-muted small">Haz clic en un registro de la lista para ver su información completa.</p>
                                            </div>
                                            ...
                                            <div id="detailContent" style="display:none;">
                                                ...
                                                <div class="detail-header">
                                                    ...
                                                    <div class="d-flex gap-2">
                                                        ...
                                                        <button type="button" class="btn btn-outline-secondary btn-sm" onclick="closeDetail()">
                                                            <span class="material-symbols-outlined align-middle" style="font-size:18px;">close</span>
                                                        </button>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="detail-tabs">
                                                    <div class="detail-tab active" data-tab="info">
                                                        <span class="material-symbols-outlined align-middle" style="font-size:16px;">badge</span> Info
                                                    </div>
                                                    <div class="detail-tab" data-tab="procesos">
                                                        <span class="material-symbols-outlined align-middle" style="font-size:16px;">work_history</span> Procesos
                                                        <span class="badge bg-secondary" id="badgeVacantesCount">0</span>
                                                    </div>
                                                    <div class="detail-tab" data-tab="telefonos">
                                                        <span class="material-symbols-outlined align-middle" style="font-size:16px;">phone</span> Teléfonos
                                                    </div>
                                                </div>
                                                ...
                                                <div class="detail-tab-panel" id="tabProcesos">
                                                    <div class="row g-0">
                                                        <div class="col-md-5 vacantes-sidebar">
                                                            <h6 class="px-3 pt-2 fw-bold text-muted small text-uppercase">Vacantes</h6>
                                                            <div id="listaPostulaciones">
                                                                <div class="text-muted small px-3">Selecciona un postulante</div>
                                                            </div>
                                                            <div class="mt-3 pt-2 border-top px-3">
                                                                <h6 class="fw-bold text-muted small text-uppercase mb-2">Documentos</h6>
                                                        ...
                                                        <div class="col-md-7 p-3">
                                                            ...
                                                            <div id="seccionResultadosEvaluacion" style="display:none;" class="mt-4 pt-3 border-top">
                                                                <h6 class="fw-bold mb-3">
                                                                    <span class="material-symbols-outlined align-middle me-2" style="font-size:18px;">analytics</span>
                                                                    Resultados de Evaluación
                                                                </h6>
                                                                <div id="resultadosEvaluacionContent">
                                                                    <div class="text-muted small">Cargando resultados...</div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="detail-tab-panel" id="tabTelefonos">
                                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                                        <h6 class="fw-bold mb-0">
                                                            <span class="material-symbols-outlined align-middle" style="font-size:18px;">phone</span>
                                                            Historial de Teléfonos
                                                        </h6>
                                                        <button type="button" class="btn btn-outline-success btn-sm" onclick="PostulanteEditor.mostrarFormAgregarTelefono()">
                                                            <span class="material-symbols-outlined align-middle" style="font-size:16px;">add</span> Agregar
                                                        </button>
                                                    </div>
                                                    <!-- Form agregar teléfono -->
                                                    <div id="formAgregarTelefono" class="d-none mb-3 p-3 border rounded">
                                                        <div class="row g-2 align-items-end">
                                                            <div class="col-md-5">
                                                                <label class="form-label small">Número (10 dígitos)</label>
                                                                <input type="text" id="nuevoTelefono" class="form-control" placeholder="5512345678" maxlength="10">
                                                            </div>
                                                            <div class="col-md-4">
                                                                <label class="form-label small">Observaciones</label>
                                                                <input type="text" id="observacionesTelefono" class="form-control" placeholder="Nota opcional">
                                                            </div>
                                                            <div class="col-md-3">
                                                                <button type="button" class="btn btn-success w-100" onclick="PostulanteEditor.agregarTelefonoNuevo()">
                                                                    <span class="material-symbols-outlined align-middle" style="font-size:16px;">save</span> Guardar
                                                                </button>
                                                                <button type="button" class="btn btn-outline-secondary w-100 mt-1" onclick="PostulanteEditor.ocultarFormAgregarTelefono()">
                                                                    Cancelar
                                                                </button>
                                                            </div>
                                                        </div>
