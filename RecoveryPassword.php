        ...
        <div class="app-auth-container">
            ...
            <div class="logo" style="padding: 10px 0; position: relative; left: -30px;">
                ...
                <a href="index.html"
                    ...
                    <div style="font-size: 1.3rem; font-weight: 600; color: #222; letter-spacing: 1px;">Intranet La
                        Esmeralda
            ...
            <div class="auth-credentials m-b-xxl">
                ...
                <input type="password" class="form-control m-b-md" id="txtPass1" aria-describedby="txtPass1"
                ...
                <input type="password" class="form-control" id="txtPass2" aria-describedby="txtPass2"
                    placeholder="&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;" required>
