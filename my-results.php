        ...
        <div class="page-wrapper">
            <div class="page-titles">
                <div class="d-flex align-items-center">
                    <h5 class="font-medium m-b-0">Mis resultados</h5>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col s12">
                  <div class="card">
                    <div class="card-content">
                      <h6>En este apartado se muestra un listado de todos los resultados finales del evaluado actual</h6>
                      <div class="table-responsive">
                        <!-- <table class="centered" id="table_general" style="width:100%;">
                          <thead>
                            <tr>
                              <th style="width:15%;">Evaluación</th>
                              <th style="width:15%;">Mis Evaluadores</th>
                              <th style="width:15%;">Avance Evaluadores</th>
                              <th style="width:15%;">Retroalimentación </th>
                              <th style="width:10%;">Grupo Durante la evaluación</th>
                              <th style="width:15%;">Plan de acción</th>
