...
<body>
        ...
        <div class="page-wrapper">
            <div class="page-titles">
                <div class="d-flex align-items-center">
                    <h5 class="font-medium m-b-0">Peticiones para el Feed.</h5>
                </div>
            </div>
            <div class="row">
                    ...
                    <div class="e-card-header">
                      <div class="e-card-header-caption">
                        <div class="e-card-header-title">
                          Listado de peticiones de los empleados comunes para el feed.
                        </div>
                      </div>
                    </div>
                    <div class="e-card-content">
                      <ul class="collapsible" id="contentPost"></ul>
                    </div>
                  </div>
                </div>
              </div>
    ...
    <script src="/scripts/post-requests-original.js" charset="utf-8"></script>
</body>
