...
<body>
    <div class="app app-auth-sign-in align-content-stretch d-flex flex-wrap justify-content-end">
        ...
        <div class="app-auth-container">
            ...
            <div class="auth-credentials m-b-xxl">
                ...
                <input type="text" class="form-control m-b-md" id="NoEmpleado" aria-describedby="NoEmpleado"
                    placeholder="0000000" onkeypress="return onlynumber(event)" required>
            ...
            <div class="auth-submit">
                ...
                <a style="cursor: pointer;" class="auth-forgot-password float-end" id="to-recover">Olvidaste la
                    contraseña?</a>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" id="modalRecuperarPassword" tabindex="-1" aria-labelledby="modalRecuperarPasswordLabel"
        aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="p-3">
                        ...
                        <div class="mb-3">
                            <input type="email" class="form-control" id="txtEmailRecuperarPass"
