  ...
  <div class="app align-content-stretch d-flex flex-wrap" id="main-wrapper">
    ...
    <div class="app-container">
      ...
      <div class="app-content">
        ...
        <!-- Modal Update Puesto -->
        <div class="modal fade" id="divUpdatePuesto" tabindex="-1" aria-labelledby="divUpdatePuestoLabel"
          aria-hidden="true">
              ...
              <div class="modal-body">
                ...
                <div class="container-fluid">
                  <div class="row g-3 justify-content-center">
                    ...
                    <div class="col-12 text-center">
                      <h6>Descripción</h6>
                      <input type="text" id="txtPuestoUpdate"
        ...
        <!-- Modal Listar Jefes -->
        <div class="modal fade" id="modalListPuestos" tabindex="-1" aria-labelledby="modalListPuestosLabel"
          aria-hidden="true" style="overflow: visible !important;">
        ...
        <!-- Modal Nuevo Puesto -->
        <div class="modal fade" id="modalNuevoPuesto" tabindex="-1" aria-labelledby="modalNuevoPuestoLabel"
          aria-hidden="true">
