                                    ...
                                    <div class="card-content">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class=" col s12 l12" style="text-align:center">
                                                ...
                                                <button class="btn"
                                                    id="btnActualizaMensajeBienvenida">Actualizar</button>
                                    ...
                                    <div class="card-content">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class=" col s12 l12" style="text-align:center">
                                                ...
                                                <button class="btn" id="btnViewDiasFestivos">Actualizar días
                                                    festivos.</button>
            ...
            <div style="display:none;">
                ...
                <div class="row" id="divDiasFestivos">
                    ...
                    <div class="col s12 l12">
                        ...
                        <div class="row"
                            style="padding:2vh;box-shadow: rgba(67, 71, 85, 0.27) 0px 0px 0.25em, rgba(90, 125, 188, 0.05) 0px 0.25em 1em;">
                            ...
                            <div class="col s12 l12" style="text-align:center">
                                ...
                                <button type="button" class="btnAceptarVerde" id="btnAddDiaF">Agregar día
                                    Festivo</button>
                    ...
                    <div class="col s12 l12">
                        ...
                        <div class="row" style="padding:4vh">
                            ...
                            <div class="col s12 l12" style="text-align:center">
                                ...
                                <button type="button" class="btnAceptarVerde" id="btnUpdateDF">Actualizar día
                                    Festivo</button>
