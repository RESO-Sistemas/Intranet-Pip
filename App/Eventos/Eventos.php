<?php
  ...
  class Eventos extends Conexiones {
    function getEventosDetalle ($fecha,$NoEmpleado) {
        $ArrayRetorno = [];
        $Datos = [];
        ...
        $DetalleEventosCapacitacion = $EventosCapacitacion->getEventoDetalleCapacitacion($fechaSinFormatear,$FechaAgenda,$FechaMesDia,$NoEmpleado);
        $Datos = [
        ...
        return '{ "GetDetalleEvento": '.json_encode($ArrayRetorno)."}";
    }
    ...
    function getEventoDetalleCapacitacion ($fechaSinFormatear,$FechaAgenda,$FechaMesDia,$NoEmpleado) {
        $ArrayRetorno = [];
        $DatosArr = [];
    ...
    function getEventos ($fecha) {
      ...
      return '{ "GetEventos": '.json_encode($cons)."}";
    }

    function getDatosEvento ($idEventos) {
      $q = "SELECT * FROM Eventos
            WHERE idEventos = '$idEventos';";
      return '{ "getDatosEvento": '.json_encode($this->Select($q,array()))."}";
    }
  }
 ?>
