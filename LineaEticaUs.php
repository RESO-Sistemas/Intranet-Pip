											...
											<form id="formLineaEtica" action="Backend/LineaEtica/App.php" method="post">
												...
												<div class="row justify-content-center mb-4">
													<div class="col-12 col-md-auto text-center">
														<span
															class="badge badge-style-bordered rounded-pill badge-warning d-inline-block"
															style="font-size: 0.875rem; padding: 0.5rem 1rem; word-wrap: break-word; max-width: 100%;">
												...
												<div class="row mb-4">
													...
													<div class="col-12 col-md-6">
														...
														<select id="sl_branch" name="sucursal"
															class="form-control form-select" required disabled>
															<option value="" selected disabled>Seleccione una sucursal
															</option>
														</select>
												...
												<div class="row justify-content-center mb-2">
													<div class="col-12 text-center">
														...
														<small class="text-muted d-block">Selecciona la situación que
															quieres reportar.</small>
													</div>
												</div>
												...
												<div class="row justify-content-center mb-4">
													<div class="col-12">
														<label for="contenidoLineaEtica" class="form-label">Describe la
															situación o inconformidad que presentes:</label>
														<textarea id="contenidoLineaEtica" name="contenidoLineaEtica"
															class="form-control" style="height:15vh; min-height: 120px;"
												...
												<div class="row justify-content-center mb-4">
													<div class="col-12 col-md-auto text-center">
														<button class="btn btn-success w-100 w-md-auto px-5"
															id="EnviarLineaE" style="max-width: 300px;">Enviar</button>
													</div>
												</div>
											</form>
										</div>
