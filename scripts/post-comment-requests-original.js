...
function printCommentsRequests(data){
  ...
  tCommentsRequests = new ej.grids.Grid({
    ...
    columns: [
      ...
      { field: "idComentariosFeed", headerText: "", width: 25, visible: false, sPrimaryKey: true},
...
async function executeActionComments(data, cant, action){
  ...
  for (var i = 0; i < cant; i++) {
    dataSelected.push(tCommentsRequests.dataSource[data[i]]["idComentariosFeed"]);
  }
  let dataSend = {
...
const printCommentsRequestsAccepted = (data) => {
  ...
  tCommentsAccepted = new ej.grids.Grid({
    ...
    columns: [
      ...
      { field: "idComentariosFeed", headerText: "", width: 25, visible: false, sPrimaryKey: true},
      { field: "Nombre", headerText: "EMPLEADO", width: 120,},
      { field: "Comentario", headerText: "COMENTARIO", width: 140,},
      { field: "Registro", headerText: "FECHA COMENTARIO", width: 100,},
      { field: "FechaRevisado", headerText: "FECHA AUTORIZADO", width: 100,},
    ]
  });
