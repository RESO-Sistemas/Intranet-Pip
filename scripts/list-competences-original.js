...
function printListCompetences(data){
  ...
  tableCompSF = new ej.grids.Grid({
    ...
    columns: [
      { field: "Competencia", headerText: "Competencia", width: 70, textAlign: 'Center', allowFiltering: false},
      { field: "Tipo", headerText: "Tipo de Competencia", width: 70, textAlign: 'Center', filter: { type : 'CheckBox' }} ,
      { field: "StatusCom", headerText: "Status", width: 70, textAlign: 'Center', filter: { type : 'CheckBox' },template: "#statusTemplate",},
      { field: "idCompetencia", headerText: "Cambiar Status", width: 40, textAlign: 'Center', filter: { type : 'CheckBox' },template: "#updateStatusTemplate",},
      { field: "idCompetencia", headerText: "Editar competencia", width: 40, textAlign: 'Center', filter: { type : 'CheckBox' },template: "#viewDetailCompetenceTemplate",} ,
    ],
  });
