...
async function toggleEstatus(idEncoded) {
    ...
    const confirmed = confirm('¿Está seguro de cambiar el estatus de esta área técnica?');
...
async function deleteAreaTecnica(idEncoded) {
    // Confirmación simple con confirm nativo
    const confirmed = confirm('Esta acción no se puede deshacer. ¿Está seguro de eliminar esta área técnica?');
