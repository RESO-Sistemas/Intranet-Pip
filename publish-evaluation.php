...
?>
			...
			<div class="app-content">
				...
				<div class="content-wrapper">
					...
					<div class="container">
										...
										<div class="row w-100 d-flex justify-content-between mb-4">
											...
											<div class="col-4 d-flex flex-column gap-2">
												...
												<button type="button" class="btn btn-primary"
													id="btn_saveConfig">Guardar la configuración de
													las sucursales.</button>
											...
											<div class="col-12 text-center">
												...
												<div class="row" id="card_branch">
													...
													<div class="col-6">
														...
														<select class="form-select" id="listBranch_sel" multiple
													...
													<div class="col-6">
														...
														<select class="form-select" id="sel_typeSelBranch"
															style="width: 100%;">
										...
										<div class="col-12 mb-4" id="card_showBranch">
											...
											<div class="row">
												...
												<div class="col-12">
													...
													<select class="form-select" id="selct_AllBranch"
														style="width:100%;"></select>
						...
						<div class="modal fade" id="contentNewEvaluator" aria-labelledby="modalLabelNewEvaluator"
							aria-hidden="true">
									...
									<div class="modal-body">
										...
										<div class="row">
											...
											<div class="col-12 mb-3">
												...
												<label for="slct_newEvaluated" class="form-label">Seleccione al
													evaluado</label>

												<select class="form-select" id="slct_newEvaluated"
													style="width:100%"></select>
											...
											<div class="col-12 mb-3">
												...
												<label for="slct_newEvaluator" class="form-label">Seleccione al
													evaluador</label>

												<select class="form-select" id="slct_newEvaluator"
													style="width:100%"></select>
											...
											<div class="col-12 mb-4">
												...
												<label for="typeNewEvaluator" class="form-label">Relación del empleado
													evaluador</label>
	...
	<script src="scripts/publish-evaluation/data.js?v=<?= time() ?>"
		charset="utf-8"></script>
	<script src="scripts/publish-evaluation/general.js?v=<?= time() ?>"
		charset="utf-8"></script>
