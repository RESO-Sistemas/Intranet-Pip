                  ...
                  <div id="divContenidobirthday">
                    ...
                    <div class="col s12 l12" style="text-align:center;" style="width:60vh;height:60vh;">
                      <form id="formInsertaImgBirthday">
                        ...
                        <img src="assets/cumplecursor.png" alt="ImgCumpleaños" id="imgPreview"
                        ...
                        <input type="file" style="display:none;" accept="image/png, image/jpeg"
                          ...
                          onchange="previewImage(event,'#imgPreview')" required></input>
                        <hr>
                      </form>
                    </div>
                  ...
                  <div id="divContenidoanniversary">
                    ...
                    <div class="col s12 l12" style="text-align:center;" style="width:60vh;height:60vh;">
                      <form id="fprmInsertaImgAnniversary">
                        ...
                        <img src="assets/cumplecursor.png" alt="ImgAnniversary" id="imgPreviewAnn"
                          style="height:50vh;cursor:pointer;">
                        <input type="file" style="display:none;" name="ContenidoImgAnniversary"
                          accept="image/png, image/jpeg" id="ContenidoImgAnniversary"
                          onchange="previewImageAnny(event,'#imgPreviewAnn')" required></input>
                      </form>
                      <hr>
                    </div>
                    <div class="col s12 l12" style="text-align:center;">
