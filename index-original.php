...
<link rel="stylesheet" href="/plugins/unitegallery-master/source/unitegallery/skins/alexis/alexis.css">
  <style media="screen">
    ...
    .btn-newPublication::before, .btn-newPublication::after {
      content: "";
      display: block;
      position: absolute;
      top: 50%;
                  ...
                  <div class="e-card-content" style="padding:15px;">
                    <div class="row">
                      ...
                      <div class="col s12 l4" style="text-align:center">
                        ...
                        <a href="Archivos/AppInstall/com.reso.klynet.apk" target="_blank" class="btn-floating  darken-2 m-t-10">
                        ...
                        <form>
                          ...
                          <div class="row">
                            ...
                            <div class="input-field col s12 l4">
                              ...
                              <input id="Perfilnumber" type="text" value="" onkeypress="return onlynumber(event)" maxlength="10">
                            </div>
                          </div>
                          ...
                          <div class="row">
                            <div class="input-field col s12 l12" style="text-align:center;">
                              <button class="btn teal waves-effect waves-light" style="width:50%" type="button" name="action" id="UpdateDatosEmp" onclick="updateDatosEmpleado()">Actualiza Perfil</button>
                              <hr>
                              <a href="AddFirma.php" class="btn blue darken-2 modal-close save-category">Actualizar Firma</a>
                            </div>
                            <div class="col s12" style="background-color:#f3f3f3; height:200px; border-radius:15px; text-align: center;">
