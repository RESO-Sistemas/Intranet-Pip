...
<body>
  ...
  <div class="text-center mb-3">
    <label class="card-title">Evaluación seleccionada: <b id="ev_selected"></b></label>
  </div>
  <div id="contenidoResGlobal">
    <div class="row d-flex justify-content-center align-items-center text-center mb-4">
      <div class="col"><div id="principalTable"></div></div>
    </div>
  </div>
  ...
  <div class="modal fade" id="modalGeneralDetail" tabindex="-1" aria-labelledby="modalGeneralDetailLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-scrollable"><div class="modal-content">
      ...
      <div class="modal-body" id="container-generalDetail">
        <div class="row d-flex justify-content-center mb-4"><div class="col-12"><div id="finalTableEvaluated"></div></div></div>
        ...
        <div class="row d-flex justify-content-center mb-4"><div class="col-12"><div id="contentAllResultsFinal" class="row"></div></div></div>
        <div class="row d-flex justify-content-center"><div class="col-12">
          <div class="row dv_ContentAllResults">
            <div id="gn_calculo" class="col-12">
              ...
              <div class="row"><div class="col-12"><div id="dvFisrtPage" class="row"></div></div></div>
            </div>
            <div id="gn_par_sub" class="col-12">
              <div class="row"><div class="col-12"><div class="row justify-content-center">
                <div class="col-12"><div class="row">
                  <div class="col-12 mt-4 mb-4"><label class="form-label">Resultados Individuales (Pares)</label></div>
                  <div class="col-12"><div id="dv_ind_Par" class="row"></div></div>
                </div></div>
                <div class="col-12"><div class="row">
                  <div class="col-12 mt-4 mb-4"><label class="form-label">Resultados Individuales (Subordinados)</label></div>
                  <div class="col-12"><div id="dv_ind_Subordinado" class="row"></div></div>
                </div></div>
              </div></div></div>
            </div>
            <div id="gn_moreInfo" class="col-12">
              <div class="row d-flex justify-content-center"><div class="col-12 text-center"><label class="form-label">Resultado Global</label></div></div>
              <div class="row d-flex justify-content-center mb-4"><div class="col-12"><label class="form-label">Resultados Finales:</label><div id="total_General"></div></div></div>
              <div class="row d-flex justify-content-center mt-4"><div class="col-12 text-center">
                <label class="form-label text-center">Fortalezas y Áreas a Mejorar</label>
                <div class="row d-flex justify-content-center">
                  <div class="col-12 col-md-6 text-center mb-3"><label class="form-label">Fortalezas:</label><div id="table_strengths"></div></div>
                  <div class="col-12 col-md-6 text-center"><label class="form-label">Áreas a Mejorar:</label><div id="table_areasForImprovement"></div></div>
                </div>
              </div></div>
              <div class="row d-flex justify-content-center"><div class="col-12 mt-4 d-flex justify-content-center">
                <div id="container"><div class="form-label col-12" id="graph_total_General"></div></div>
              </div></div>
            </div>
          </div>
        </div></div>
  ...
  <div class="modal fade" id="detailContainer" tabindex="-1" aria-labelledby="detailContainerLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-scrollable modal-dialog-centered"><div class="modal-content">
      ...
      <div class="modal-body">
        <div class="text-center mb-3"><label class="form-label">Detalle de los Evaluadores:</label></div>
        ...
        <div class="row justify-content-center align-items-center">
          <div class="col-12 col-md-8 text-center">
            ...
            <div class="row p-2">
              <div class="col-12 col-md-6 text-center mb-3"><label class="form-label">Fortalezas:</label><div id="ev_strengths"></div><hr></div>
              <div class="col-12 col-md-6 text-center"><label class="form-label">Áreas a mejorar:</label><div id="ev_weaknesses"></div></div>
            </div>
          </div>
        </div>
        <div class="row w-100 d-flex justify-content-center">
          <div class="col-12 mt-4 d-flex justify-content-center">
            <div id="container"><div id="indvChar" style="height:580px;overflow-x:auto;"></div></div>
          </div>
        </div>
      </div>
    </div></div>
