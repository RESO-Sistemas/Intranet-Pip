...
<head>
  ...
  <style>
    /* ── Reset embed ── */
    body { padding: 0; margin: 0; background: #F8FAFC; font-family: 'DM Sans', sans-serif; }

    /* ── Loader ── */
    #embedLoader { position: fixed; inset: 0; background: #fff; display: flex; flex-direction: column; align-items: center; justify-content: center; z-index: 9999; gap: 14px; }

    /* ── Material Symbol helper ── */
    .ms { font-family: 'Material Symbols Outlined'; font-size: 18px; font-style: normal; line-height: 1; vertical-align: middle; }
    ...
    .res-page-header-label { font-size: 0.73rem; font-weight: 700; color: #94A3B8; text-transform: uppercase; letter-spacing: 0.6px; line-height: 1.2; }
    .res-page-header-title { font-size: 0.95rem; font-weight: 700; color: #1E293B; margin: 0; line-height: 1.3; }

    /* ── Contenedor principal ── */
    .res-main-wrap { padding: 1rem 1rem 1.5rem; }
    ...
    /* Filas de la lista */
    #res-evaluados-list { display: flex; flex-direction: column; gap: 0; }
    ...
    .res-row:first-child { border-radius: 12px 12px 0 0; }
    .res-row:last-child  { border-bottom: 1px solid #E9EEF5; border-radius: 0 0 12px 12px; }
    .res-row:only-child  { border-radius: 12px; border-bottom: 1px solid #E9EEF5; }
    ...
    /* Badge de estado */
    .res-row-status { flex-shrink: 0; }
    .res-status-badge {
      display: inline-flex; align-items: center; gap: 4px;
      padding: 3px 10px; border-radius: 20px;
      font-size: 0.72rem; font-weight: 700; white-space: nowrap;
    }
    .res-status-badge.complete  { background: #DCFCE7; color: #15803D; }
    .res-status-badge.pending   { background: #FEF9C3; color: #854D0E; }

    /* Acciones */
    .res-row-actions { display: flex; gap: 6px; flex-shrink: 0; }
    .res-action-btn {
    ...
    .res-action-btn.detail:hover { background: #F1F5F9; color: #334155; border-color: #94A3B8; }
    .res-action-btn.results {
      border-color: #BBF7D0; color: #15803D; background: #F0FDF4;
    }
    .res-action-btn.results:hover { background: #DCFCE7; border-color: #86EFAC; }
    .res-action-btn:disabled { opacity: 0.35; cursor: not-allowed; }

    /* Tooltip nativo */
    .res-action-btn[title] { position: relative; }
    ...
    .res-empty .ms { font-size: 36px; color: #CBD5E1; display: block; margin-bottom: 8px; }
    .res-empty p { font-size: 0.85rem; color: #94A3B8; margin: 0; }
    ...
    #modalGeneralDetail.is-open { transform: translateX(0); }
    ...
    .res-hero-left { display: flex; align-items: center; gap: 14px; }
    .res-hero-avatar {
    ...
    .res-hero-name { font-size: 0.97rem; font-weight: 700; color: #fff; margin: 0; }
    .res-hero-meta { font-size: 0.76rem; color: #94A3B8; margin: 0; }
    .res-hero-right { display: flex; gap: 8px; flex-wrap: wrap; align-items: center; }
    .res-hero-badge {
      background: rgba(255,255,255,0.1); border: 1px solid rgba(255,255,255,0.18);
      color: #E2E8F0; border-radius: 8px; padding: 4px 11px;
    ...
    .res-hero-close:hover { background: rgba(255,255,255,0.2); }
    ...
    .res-emp-info-cell:last-child { border-right: none; }
    .res-emp-info-key { font-size: 0.68rem; font-weight: 700; color: #94A3B8; text-transform: uppercase; letter-spacing: 0.5px; margin-bottom: 2px; }
    .res-emp-info-val { font-size: 0.85rem; font-weight: 600; color: #1E293B; }
    ...
    .res-modal-tab {
      ...
      padding: 0.72rem 1rem; font-size: 0.82rem; font-weight: 600;
    ...
    @media (max-width: 768px) { .res-two-col { grid-template-columns: 1fr; } }

    .res-panel {
      background: #fff; border: 1px solid #E9EEF5; border-radius: 12px; overflow: hidden;
    }
    .res-panel-header {
      display: flex; align-items: center; gap: 8px;
      padding: 0.65rem 0.9rem; border-bottom: 1px solid #F1F5F9; background: #FAFBFF;
    }
    .res-panel-icon {
    ...
    .res-panel-title { font-size: 0.8rem; font-weight: 700; color: #1E293B; margin: 0; }
    .res-panel-body { padding: 0.75rem 0.9rem; }

    .res-radar-wrap {
      display: flex; align-items: center; justify-content: center;
      min-height: 300px; padding: 0.75rem;
    }
    .res-radar-wrap > div { width: 100% !important; min-height: 280px; }

    .res-sw-grid { display: grid; grid-template-columns: 1fr 1fr; gap: 0.65rem; margin-top: 0.75rem; }
    @media (max-width: 576px) { .res-sw-grid { grid-template-columns: 1fr; } }

    .res-sw-card { border-radius: 10px; padding: 0.65rem 0.75rem; border: 1px solid; }
    .res-sw-card.strengths  { background: #F0FDF4; border-color: #BBF7D0; }
    .res-sw-card.weaknesses { background: #FFF7ED; border-color: #FED7AA; }
    .res-sw-card-title {
      font-size: 0.7rem; font-weight: 700; text-transform: uppercase;
      letter-spacing: 0.5px; margin-bottom: 0.45rem;
      display: flex; align-items: center; gap: 4px;
    }
    .res-sw-card.strengths  .res-sw-card-title { color: #15803D; }
    .res-sw-card.weaknesses .res-sw-card-title { color: #C2410C; }
    ...
    #detailContainer.is-open { transform: translateX(0); }
    ...
    .res-detail-hero-left { display: flex; align-items: center; gap: 12px; min-width: 0; }
    ...
    .res-detail-hero-meta { font-size: 0.78rem; color: #64748B; margin: 1px 0 0; }
    ...
    .res-detail-close:hover { background: #F1F5F9; border-color: #94A3B8; }
    ...
    @media (max-width: 768px) { .res-detail-body { grid-template-columns: 1fr; } }
  </style>
</head>
<body>
  <div id="embedLoader">
    <div class="spinner-border text-warning" style="width:2.2rem;height:2.2rem;" role="status"><span class="visually-hidden">Cargando...</span></div>
      ...
      <div class="dv_ContentAllResults">
        ...
        <div id="gn_par_sub" style="display:none; padding:1.1rem;">
          <div class="res-panel mb-3">
            ...
            <div class="res-panel-body"><div id="dv_ind_Par"></div></div>
          </div>
          <div class="res-panel">
            <div class="res-panel-header">
            ...
            <div class="res-panel-body"><div id="dv_ind_Subordinado"></div></div>
          </div>
        </div>
  ...
  <div id="detailContainer" aria-labelledby="detailContainerLabel" aria-hidden="true">
    ...
    <div class="res-detail-panel-body">
      <!-- Info strip -->
      <div class="res-emp-info-card" style="margin:0; border-radius:0; border-left:none; border-right:none; border-top:none;">
      ...
      <div class="res-detail-body">
        <div>
          <div class="res-panel">
            ...
            <div class="res-panel-body"><div id="table_qualifications"></div></div>
          </div>
          <div class="res-sw-grid">
            <div class="res-sw-card strengths">
              <div class="res-sw-card-title"><span class="ms ms-sm">star</span> Fortalezas</div>
