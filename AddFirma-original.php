...
<body data-theme="">
   <div class="main-wrapper" id="main-wrapper">
      <div class="page-wrapper">
          <div class="row">
            <div class="col s2" style="position:absolute; margin-top:5vh">
              <a href="<?=$_SERVER["HTTP_REFERER"]?>"><button id="Regresar" class="waves-effect waves-light btn btn-round orange"> Regresar </button></a>
            </div>
            <div class="col s12" style="text-align:center;margin-top: 5vh">
              <h3>Nueva / Actualizar firma</h3>
            </div>
