                ...
                <div class="row">
                    ...
                    <div class="col s12 l3 offset-l9">
                        ...
                        <div class="container">
                            ...
                            <button data-target="CatalogoLineaEica" class="btn modal-trigger">Ver Catálogo Línea
                                Ética</button>
        ...
        <div id="CatalogoLineaEica" class="modal" style="min-height:80vh">
            ...
            <div class="modal-content">
                ...
                <div class="row">
                    ...
                    <div class="col s12 l12"
                        ...
                        <div class="row">
                            ...
                            <div class="col s4 l4" style="text-align:right">
                                ...
                                <a class="waves-effect waves-light btn btn-round indigo" style="margin-top:2vh"
                                    id="btnAgregaNuevoCatalogo">Agregar Nuevo</a>
                    ...
                    <div class="col s12 l12"
                        style="box-shadow: rgba(0, 0, 0, 0.16) 0px 3px 6px, rgba(0, 0, 0, 0.23) 0px 3px 6px;margin-top:2vh">

                        <div class="table-responsive">

                            <table id="tableCatalogoLiniaEtica" class="table striped m-b-10 display centered"
                                style="min-height:auto;max-height:40vh; overflow-y:scroll;">
