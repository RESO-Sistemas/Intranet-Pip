        ...
        <div class="page-wrapper">
            <div class="page-titles">
                <div class="d-flex align-items-center">
                    <h5 class="font-medium m-b-0">Mis planes de acción</h5>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col s12">
                  <div class="card">
                    <div class="card-content">
                      <div class="row">
                        <h6 class="card-title">En este apartado se encuentra un listado de los planes de acción generados para el usuario actual</h6>
