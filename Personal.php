									...
									<div class="card-body">
										...
										<div class="row">
											...
											<div class="col-12 col-sm-6" style="display: none;">
												...
												<div class="row g-2 align-items-center flex-nowrap flex-sm-wrap">
													...
													<div class="col-auto">
														...
														<input type="file" class="d-none" id="excel-input"
															accept=".xlsx">
													</div>
											...
											<div class="col-12 col-sm-6" style="display: none;">
												...
												<div class="row g-2 align-items-center flex-nowrap flex-sm-wrap">
													<!-- Botón File -->
													<div class="col-auto">
														<label for="excel-inputVacaciones"
															class="btn btn-primary w-100">
															<span class="material-symbols-outlined">upload</span>
														</label>
														<input type="file" class="d-none" id="excel-inputVacaciones"
															accept=".xlsx">
													</div>
										...
										<div class="row g-3">
											...
											<div class="col-12 col-md-4">
												...
												<select id="slctSucursal" class="form-select"
													onchange="getListadoPersonal()">
								...
								<div class="container-fluid">
									<div class="row g-3 justify-content-center">
										...
										<div class="col-12 col-md-6 text-center">
											...
											<input type="text" id="inpMovilDet"
												class="form-control form-control-solid-bordered text-center"
												onkeypress="return onlynumber(event)" required>
										</div>
										<div class="col-12 col-md-6 text-center">
											<h6>RFC <span class="text-danger">*</span></h6>
											<input type="text" id="inpRFCDet"
												class="form-control form-control-solid-bordered text-center" required>
										</div>
										<div class="col-12 col-md-6 text-center">
											<h6>CURP <span class="text-danger">*</span></h6>
											<input type="text" id="inpCURPDet"
												class="form-control form-control-solid-bordered text-center" required>
										</div>
										...
										<div class="col-12 text-center">
											...
											<input type="number" id="inpNivelDet"
												class="form-control form-control-solid-bordered text-center" required>
										</div>
										<div class="col-12 text-center">
								...
								<form id="formUpdateMasDetalles" method="post">
									...
									<div class="row g-3">
										<div class="col-12 col-md-6">
											...
											<input type="email" id="inpEmailMasDetalles"
												class="form-control form-control-solid-bordered" readonly>
										</div>
										<div class="col-12 col-md-6">
											<label class="form-label">Celular</label>
											<input type="text" id="inpMovilMasDetalles"
												class="form-control form-control-solid-bordered" readonly>
										</div>
										<div class="col-12 col-md-6">
											<label class="form-label">RFC</label>
											<input type="text" id="inpRFCMasDetalles"
												class="form-control form-control-solid-bordered" readonly>
										</div>
										<div class="col-12 col-md-6">
											<label class="form-label">CURP</label>
											<input type="text" id="inpCURPMasDetalles"
												class="form-control form-control-solid-bordered" readonly>
										</div>
										<div class="col-12 col-md-6">
											<label class="form-label">No. Seguro</label>
											<input type="text" id="inpNoSeguroMasDetalles"
												class="form-control form-control-solid-bordered" readonly>
										</div>
										<div class="col-12 col-md-6">
											<label class="form-label">Nivel</label>
											<input type="number" id="inpNivelMasDetalles"
												class="form-control form-control-solid-bordered" readonly>
										</div>
										<div class="col-12 col-md-5 text-center mt-3">
											<label class="form-label">División actual</label>
											<select id="slctDivisionActual" name="slctDivisionActual"
												class="form-select" onchange="onchangeDivision()" required></select>
										</div>

										<div class="col-12 col-md-7 text-center mt-3">
											<label class="form-label">Puesto actual</label>
											<select id="slctPuestoActual" name="slctPuestoActual" class="form-select"
												required></select>
										</div>

										<div class="col-12 text-center mt-3">
											<label class="form-label">Sucursal actual</label>
											<select id="slctSucursalActual" name="slctSucursalActual"
						...
						<div class="modal-content">
							...
							<div class="modal-body" style="padding: 30px;">
								<div class="container-fluid">
									<div class="row g-3 justify-content-center">
										<div class="col-12">
											<label class="form-label fw-bold mb-3" style="font-size: 16px;">Selecciona
												el jefe
												asignado:</label>
											<select class="form-select form-select-solid-bordered"
												id="listadoJefesPosibles" onchange="asignarJefeEmpleado(this.value)">
