...
<body>
        ...
        <div class="page-wrapper">
            <div class="page-titles">
                <div class="d-flex align-items-center">
                    <h5 class="font-medium m-b-0">Nueva Capacitación</h5>
                    ...
                    <div class="col s12 l12">
                        <div class="card">
                          ...
                          <div class="col s12 l12">
                                <form id="FormCapacitacion" method="post">
                                    <div class="row">
                                        <div class="col s12 l3">
                                            ...
                                            <select name="tipoCapacitacion" class="browser-default" onchange="tipoCap(this.value)" required>
                                        ...
                                        <div id="detalleCapacitacion" style="display:none;">
                                            ...
                                            <div class="col s4 l2">
                                                ...
                                                <input id="fechaInicio" name="fechaInicio" type="date" value="" onchange="getDiasArray()" required>
                                            </div>
                                            <div class="col s4 l2">
                                                <span id="textHoraInicio">Hora Inicio</span>
                                                <input id="HoraInicio" name="HoraInicio" type="time" value="" required>
                                            </div>
                                            <div class="col s4 l2">
                                                <span>Fecha Fin</span>
                                                <input id="fechaFin" name="fechaFin" type="date" value="" onchange="getDiasArray()" required>
                                            </div>
                                            <div class="col s4 l2">
                                            ...
                                            <div class="col s12">
                                                <div class="row">
                                                    <div class="input-field col s12" style="margin-bottom: 0.5em; margin-top:1em;">
                                                        <span>A quien vá dirigida la capacitación:</span>
                                                    </div>
                                                    <div class="input-field col s12 l4">
                                                        <select name="slctDivision" id="slctDivision" class="browser-default" onchange="onchangeDivision()" >
                                                            <option value="" selected >Listado de Divisiones</option>
                                                        </select>
                                                    </div>
                                                    <div class="input-field col s12 l4">
                                                        <select name="slctPuesto" id="slctPuestos" class="browser-default" onchange="getListadoPersonal()" >
                                                            <option value="" selected>Listado de Puestos</option>
                                                        </select>
                                                    </div>
                                                    <div class="input-field col s12 l4">
                                                        <select name="slctSucursal" id="slctSucursal" class="browser-default" onchange="getListadoPersonal()" >
                                            ...
                                            <!-- <div class="input-field col s12  ">
                                                <input type="file" name="ipn_archivo" value="" id="ipn_archivo" style="display: none;" accept="" onchange="previewFile(event,'#filePreview')" required>
                                                <button  type="button" id="NuevoArchivo" class='waves-effect waves-light btn btn-round blue'>Agregar Archivo</button>
                                            </div> -->
                                        </div>
                                    </div>
                                    <div class="col s12  l12" style="margin-top:0px;display:none;" id="divVistaPrevia">
                                            <div class="row">
                                              <div class="card card-outline card-dark shadow">
                                                <div class="card-body" style="padding:2vh">
                                                    ...
                                                    <div class="upload_drops" id="dropzones">
                                                        ...
                                                        <br>
                                                        <br>
                                                        <span class="text-danger">Nota: Se aceptan archivos e imágenes.</span><br>
                                                        <br>
                                                        <br>
                            ...
                            <div class="col s12 l6" style="display:none" id="divContenidoDias">
                                <div class="row">
                            ...
                            <div class="row contenidobox" >
                                <div class="col s12 l12">
                                  <div class="table-responsive">
                                    <button type="button" class="button-1" id="addAll">Registrar todos</button>
    ...
    <script src="scripts/AddCapacitacion-original.js"></script>
</body>
