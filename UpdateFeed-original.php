...
<body>
        ...
        <div class="page-wrapper">
            <div class="page-titles">
                <div class="d-flex align-items-center">
                    <h5 class="font-medium m-b-0">Actualizar Feed</h5>
                    ...
                    <div class="card-content">
                      <div class="row">
                        ...
                        <div class="col s12 l12">
                          ...
                          <textarea id="txtTitulo" name="txtTitulo" class="materialize-textarea"></textarea>
                        </div>
                        <div class="col s12 l12">
                          <div class="row">
                            <div class="col s12 l12">
                              <label for="txtDescripcion">Descripción</label><br>
                              <textarea id="txtDescripcion" name="txtDescripcion" class="materialize-textarea" required style="height:auto;"></textarea>
                            </div>
                            <div class="col s12 l12">
                        ...
                        <div class="card card-outline card-dark shadow">
                          <div class="card-body">
                              ...
                              <div class="upload_drops" id="dropzones">
                                  ...
                                  <input type="file" name="files[]" id="standard_filess" style="display:none;" multiple accept="application/pdf,image/jpeg,image/x-png" required>
                      ...
                      <div class="col s12 l6">
                        ...
                        <div class="col s4 offset-s4 l4 offset-l4" style="text-align:center">
                          <button id="btnUpdateFeed"  class='waves-effect waves-light btn btn-round blue'>Actualizar</button>
                        </div>
                      </div>
                    </div>
                  </div>
    ...
    <script src="scripts/UpdateFeed-original.js" charset="utf-8"></script>
</body>
