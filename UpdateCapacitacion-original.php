                          ...
                          <div class="col s12 l12">
                                <form id="FormCapacitacion" method="post">
                                    <div class="row">
                                        <div class="col s3 l3">
                                            ...
                                            <select name="tipoCapacitacion" id="tipoCapacitacion" class="browser-default" onchange="tipoCap(this.value)" required>
                                        ...
                                        <div id="detalleCapacitacion" style="display:none;">
                                            ...
                                            <div class="input-field col s5" style="margin-top:0.5vh">
                                                ...
                                                <textarea id="Desc" name="Desc" class="materialize-textarea" required style="margin-top:-1vh"></textarea>
                                            </div>
                                            <div class="col s4 l2">
                                            ...
                                            <div class="col s12">
                                                <div class="row">
                                                    ...
                                                    <div class="input-field col s4 l4">
                                                        <select name="slctDivision" id="slctDivision" class="browser-default" onchange="getListadoPersonal()" >
                                ...
                                <div class="card card-outline card-dark shadow">
                                  <div class="card-body" style="padding:2vh">
                                      ...
                                      <div class="upload_drops" id="dropzones">
                                          ...
                                          <input type="file" id="standard_filess" style="display:none;" multiple multiple accept="application/pdf,image/jpeg,image/x-png,application/vnd.ms-powerpoint">
                            ...
                            <div class="col s12 l6" >
                              <div class="row">
                                ...
                                <div class="col s12 l12" id="divContenidoArchivosActuales" style="padding:2vh;box-shadow: rgba(0, 0, 0, 0.25) 0px 0.0625em 0.0625em, rgba(0, 0, 0, 0.25) 0px 0.125em 0.5em, rgba(255, 255, 255, 0.1) 0px 0px 0px 1px inset;">
